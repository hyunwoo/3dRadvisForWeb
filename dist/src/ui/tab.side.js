...
var __UI = {
    ...
    createAxisGeometry: function createAxisGeometry() {
        ...
        $('<div class="controller">' + '<div class="name"></div>' + '<div class="component"></div>' +
        /**/'<input class="slider" data="setting" type="range" data-name="Radvis NodeSize"' + 'update="__RadvisController.updateNodes()" min="5" max="100" step=0.1/>' + '<div class="desc"></div>' + '</div>').appendTo(__UI['$settingTab']['$contents']);
